...
const words = ['Animal welfare', 'Antiracism', 'Baking', 'Biking', 'Board membership', 'Building & Repairing', 'Business & Entrepreneurship', 'Camping/Backpacking', 'Cars/Motorcycles', 'Comedy/acting', 'Civic engagement', 'Consumer protection', 'Cooking', 'Criminal justice reform', 'Dancing', 'Dining out', 'Education', 'Ending extreme poverty', 'Environment', 'Faith/Spirituality', 'Fashion', 'Financial education', 'Food security', 'Gardening', 'Golf', 'Healthy eating', 'Housing affordability', 'Hosting events/Celebrations', 'Human rights', 'Interior Design', 'Journaling', 'Knitting/Crocheting', 'Land conservation', 'Leadership', 'Learning new skills', 'Live music', 'Making movies', 'Meditation/Mindfulness', 'Mental health', 'Microfinance', 'Organizing', 'Painting or drawing', 'Personal Finance/Budgeting', 'Pets/Animals', 'Photography', 'Playing an instrument', 'Playing games', 'Politics', 'Problem solving', 'Public media', 'Puzzles/Crosswords', 'Reading/Audio books/Podcasts', 'Researching', 'Running', 'Sailing/Kayaking/Surfing', 'Self-care', 'Self-defense/Martial arts', 'Singing', 'Spending time alone', 'Spending time with others', 'Swimming', 'Taking courses/Classes', 'Teaching/Coaching/Mentoring', 'Team sports', 'Tennis', 'Theater/Performing Arts', 'Traveling', 'Volunteering', 'Voting rights', 'Watching sports', 'Watching TV/Movies', 'Weightlifting', 'Wine/Bourbon/Tequila/etc.', "Women's rights", 'Working out', 'Writing', 'Yoga'];
var p1 = "Passion 1";
var p2 = "Passion 2";
var p3 = "Passion 3";
